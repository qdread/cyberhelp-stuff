...
load("./Input_Data/effort_sum.rda")
## fishing effort raster (gfw)
load("./Input_Data/ssm_rc.rda")
...
# If we want to create partial pixels we need to convert each pixel to a polygon, 
## then clip each polygon to the "difference" between it and the Florida coast.
