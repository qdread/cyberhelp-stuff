...
filename <- "/nfs/insectinvasions-data/data/clean_data/dated_tax_files/taxonomy_table2020Oct14.csv"
...
taxtable <- read.csv('/nfs/insectinvasions-data/data/clean_data/taxonomy_table.csv')
