...
gdal_translate -co compress=LZW NUM_THREADS=8 --config GDAL_CACHEMAX 512 ${path}/ClipToMergedCounties_13class_20132014_3m.vrt ${path}/ClipToMergedCounties_13class_20132014_3m.tif
...
gdal_translate -co compress=LZW NUM_THREADS=8 --config GDAL_CACHEMAX 512 ${path}/ClipToMergedCounties_13class_20132014_1m.vrt ${path}/ClipToMergedCounties_13class_20132014_1m.tif
